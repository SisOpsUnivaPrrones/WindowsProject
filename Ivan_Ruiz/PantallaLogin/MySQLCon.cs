    ...
    public class MySQLCon
    {
        ...
        private bool OpenConnection()
        {
            ...
            catch (MySqlException ex)
            {
                ...
                {
                    case 0:
                        Msgbox.Show("Cannot connect to server.  Contact administrator");
                        break;

                    case 1045:
                        Msgbox.Show("Invalid username/password, please try again");
                        break;
                }
                return false;
            }
        ...
        public void Delete()
        {
            string query = "DELETE FROM users WHERE username='John Smith'";
